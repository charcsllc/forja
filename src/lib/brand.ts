...
export const BRAND = {
  ...
  promptPlaceholder: "Ask Buildable to create a landing page for my…",
  /** `<title>` and `og:title`. */
  metaTitle: "Buildable — Open Source Lovable Alternative",
  metaDescription:
    "Buildable is an open source, self-hosted Lovable alternative. Describe an app, watch the AI build a full-stack Next.js app live, edit it visually, publish with one click.",
...
export const STORAGE_PREFIX = "buildable";
